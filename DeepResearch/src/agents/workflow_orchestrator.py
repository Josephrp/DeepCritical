...
class WorkflowSpawnRequest(BaseModel):
    ...
    dependencies: List[str] = Field(default_factory=list, description="Dependent workflow names")
...
class MultiAgentCoordinationRequest(BaseModel):
    ...
    coordination_strategy: str = Field("collaborative", description="Coordination strategy")
...
class JudgeEvaluationResult(BaseModel):
    ...
    criterion_scores: Dict[str, float] = Field(default_factory=dict, description="Scores by criterion")
...
class PrimaryWorkflowOrchestrator:
    ...
    def _create_primary_agent(self):
        ...
        self.primary_agent = Agent(
            model_name=self.config.primary_workflow.parameters.get("model_name", "anthropic:claude-sonnet-4-0"),
    ...
    def _register_primary_tools(self):
        ...
        def compose_workflows(
            ...
            return self._compose_workflows(user_input, selected_workflows, execution_strategy)
    ...
    async def execute_primary_workflow(self, user_input: str, config: DictConfig) -> Dict[str, Any]:
        ...
        self.state.system_metrics["total_executions"] = len(self.state.completed_executions)
    ...
    def _spawn_workflow(self, request: WorkflowSpawnRequest) -> WorkflowSpawnResult:
        ...
        try:
            ...
            execution = WorkflowExecution(
                workflow_config=self._get_workflow_config(request.workflow_type, request.workflow_name),
    ...
    async def _execute_workflow_async(self, execution: WorkflowExecution):
        ...
        try:
            ...
            workflow_func = self.workflow_registry.get(execution.workflow_config.workflow_type.value)
            if not workflow_func:
                raise ValueError(f"Unknown workflow type: {execution.workflow_config.workflow_type}")
            
            # Execute workflow
            result = await workflow_func(execution.input_data, execution.workflow_config.parameters)
    ...
    def _get_workflow_config(self, workflow_type: WorkflowType, workflow_name: str):
        ...
        for workflow_config in self.config.sub_workflows:
            if workflow_config.workflow_type == workflow_type and workflow_config.name == workflow_name:
    ...
    def _coordinate_multi_agent_system(self, request: MultiAgentCoordinationRequest) -> MultiAgentCoordinationResult:
        """Coordinate a multi-agent system."""
    ...
    def _compose_workflows(self, user_input: str, selected_workflows: List[str], execution_strategy: str) -> WorkflowComposition:
        """Compose workflows based on user input."""
    ...
    async def _execute_rag_workflow(self, input_data: Dict[str, Any], parameters: Dict[str, Any]) -> Dict[str, Any]:
        """Execute RAG workflow."""
        # This would implement actual RAG workflow execution
        return {"rag_result": "placeholder", "documents_retrieved": 5}
    
    async def _execute_bioinformatics_workflow(self, input_data: Dict[str, Any], parameters: Dict[str, Any]) -> Dict[str, Any]:
        """Execute bioinformatics workflow."""
        # This would implement actual bioinformatics workflow execution
        return {"bioinformatics_result": "placeholder", "data_sources": ["GO", "PubMed"]}
    
    async def _execute_search_workflow(self, input_data: Dict[str, Any], parameters: Dict[str, Any]) -> Dict[str, Any]:
        """Execute search workflow."""
        # This would implement actual search workflow execution
        return {"search_result": "placeholder", "results_found": 10}
    
    async def _execute_multi_agent_workflow(self, input_data: Dict[str, Any], parameters: Dict[str, Any]) -> Dict[str, Any]:
        """Execute multi-agent workflow."""
        # This would implement actual multi-agent workflow execution
        return {"multi_agent_result": "placeholder", "agents_used": 3}
    
    async def _execute_hypothesis_generation_workflow(self, input_data: Dict[str, Any], parameters: Dict[str, Any]) -> Dict[str, Any]:
    ...
    async def _execute_hypothesis_testing_workflow(self, input_data: Dict[str, Any], parameters: Dict[str, Any]) -> Dict[str, Any]:
    ...
    async def _execute_reasoning_workflow(self, input_data: Dict[str, Any], parameters: Dict[str, Any]) -> Dict[str, Any]:
        """Execute reasoning workflow."""
        # This would implement actual reasoning
        return {"reasoning_result": "placeholder", "confidence": 0.9}
    
    async def _execute_code_execution_workflow(self, input_data: Dict[str, Any], parameters: Dict[str, Any]) -> Dict[str, Any]:
    ...
    async def _execute_evaluation_workflow(self, input_data: Dict[str, Any], parameters: Dict[str, Any]) -> Dict[str, Any]:
